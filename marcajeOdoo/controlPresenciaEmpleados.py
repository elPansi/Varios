...
mail['Subject'] = 'Control Presencia Diario'
...
where 
date_part('day', a.create_date ) = date_part('day', now() ) and 
date_part('month', a.create_date ) = date_part('month', now() ) and 
date_part('year', a.create_date ) = date_part('year', now() ) 
